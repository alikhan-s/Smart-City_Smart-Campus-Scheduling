...
import com.alikhan_s.topo.TopologicalSort;
...
public class Main {
    ...
    public static void main(String[] args) {
        ...
        System.out.println("--- START OF BATCH TESTING (SCC + Condensation + Topological Sort) ---");
            ...
            try {
                ...
                System.out.println("  -> New edges (between SCC): " + condensationDag.getEdges().size());
                 ...
                 for (int i = 0; i < sccSizes.length; i++) {
                    System.out.println("  -> Size SCC #" + i + ": " + sccSizes[i] + " " + sccFinder.getSccs(i));
                 }
                ...
                System.out.println("  -> Order: " + sortedOrder);
                System.out.println("Метрики (Topo): \n" + topoMetrics);
